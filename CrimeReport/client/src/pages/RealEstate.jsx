  ...
  return (
    ...
    <div className='pt-14 relative h-auto bg-[#040B11] w-auto'>
       ...
       <div className='flex items-center justify-center transform -translate-y-1/4 pb-80'>
            ...
            <img src="/trailmap.png" alt="centerimage" className='w-1/4 h-auto bg-[#040B11]'/>
       ...
       <div className='flex justify-center mt-4'>
            <div className='w-24 h-24 mr-4'>
                <a href="./Volunteers">
              <img src='/Icon1.png' alt='icon1' className='w-full h-full object-contain' /></a>
            </div>
            <div className='w-24 h-24 mr-4'>
              <a href="/">
            ...
            <div className='w-24 h-24'>
              <img src='/Icon3.png' alt='icon3' className='w-full h-full object-contain' />
            </div>
        </div>
        ...
        <div className='grid grid-cols-2 gap-3 pl-44'>
          ...
          <div className='w-[26rem] h-[26rem] pt-20 pl-10'>
            ...
            <div className='p-4 bg-white bg-opacity-5 backdrop-blur-md text-white w-[22rem] h-[22rem] rounded-3xl'>
              <h2 className='text-3xl mb-2 pt-4 flex'><PiLineVerticalBold className='text-yellow-400 size-10 -mt-1'/> Hit-spot Alerts: <img src="/Ellipse 1024.png" alt="" className='relative w-12 h-12'/><img src="/World Markets.png" alt="" className='w-12 h-12 absolute inset-0 bg-no-repeat bg-cover ml-72 mt-8'/></h2>
          ...
          <div className='grid grid-cols-2 gap-3 pl-44'>
            ...
            <div className='p-4 bg-white bg-opacity-5 backdrop-blur-md text-white w-[22rem] h-[22rem] rounded-3xl'>
              <h2 className='text-3xl mb-2 pt-4 flex'><PiLineVerticalBold className='text-green-500 -mt-1'/>Direct Donations <img src="/Ellipse 1024.png" alt="" className='relative w-12 h-12'/> <img src="/Donation.png" alt="" className='w-10 h-10 absolute inset-0 bg-no-repeat bg-cover ml-72 mt-8'/></h2>
